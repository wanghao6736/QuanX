...
@Date           2023.02.09
@Author         wanghao
@OriginalAuthor githubdulong
@ScriptURL      https://github.com/wanghao6736/QuanX/raw/master/JS/jd_price_lite.js
@Description    请打开 QuantumultX 推送权限
@Acknowledgment @githubdulong

QuantumultX 远程脚本配置:

[rewrite_local]
^https?://api\.m\.jd\.com/(client\.action|api)\?functionId=(wareBusiness|serverConfig|basicConfig|lite_wareBusiness|pingou_item) url script-response-body https://github.com/wanghao6736/QuanX/raw/master/JS/jd_price_lite.js

[mitm]
hostname = api.m.jd.com

Boxjs 订阅：https://raw.githubusercontent.com/githubdulong/Script/master/boxjs.json
*****************************************/
...
let cookiesArr = [
    ...
    ...cookieParse($tool.getCache("jd_daily") || "[]").map((item) => item.cookie),
].filter((item) => !!item);
